...
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_length = 1.   -- 0.5
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.min_num_points = 300  -- 200
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_range = 20.   -- 50.

TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.max_length = 3.    -- 0.9
TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.min_num_points = 1000   -- 100
TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.max_range = 20.   -- 50.

TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 1e2    -- 1.
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 1e2    -- 10.
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.ceres_solver_options.max_num_iterations = 30     -- 20
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.ceres_solver_options.num_threads = 2    -- 1
...
TRAJECTORY_BUILDER_2D.imu_gravity_time_constant = 8.    -- 10.

TRAJECTORY_BUILDER_2D.submaps.num_range_data = 1000    -- 90
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.grid_type = "PROBABILITY_GRID"   -- "PROBABILITY_GRID", there is also "TSDF"
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.resolution = 0.05   -- 0.05
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.range_data_inserter_type = "PROBABILITY_GRID_INSERTER_2D"   -- "PROBABILITY_GRID_INSERTER_2D", there is also "TSDF_INSERTER_2D"
...
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.tsdf_range_data_inserter.maximum_weight = 10.  -- 10.
...
POSE_GRAPH.optimize_every_n_nodes = 0     -- 90,   0 means that we turn off global slam
